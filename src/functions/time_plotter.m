function time_plotter(t,coef,time_interp,coef_interp,time_exp,coef_exp,coef_name,coef_short_name,tabgp,model_name,authors,frame,GUD,M,k,a_0,a_1,axes_size,lw,ms,t_cycle,itt,ittf)
