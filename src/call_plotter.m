function call_plotter(INPUT,frame,GUD,authors,data,params,t,alpha,c_l,c_m,c_d,c_n,c_c,alpha_interp,cn_interp,cm_interp,cc_interp,time_interp,t_cycle,x,y,iti,itt,ittf)
